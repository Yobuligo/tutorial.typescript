...
trees1.forEach((tree) => (0, GlobalFunctions_1.println)(tree.name));
...
trees2.forEach((tree) => (0, GlobalFunctions_1.println)(tree.name));
// create list without assigning it to a variable and directly print elements
[new Kiefer_1.Kiefer(), new Linde_1.Linde()].forEach((tree) => (0, GlobalFunctions_1.println)(tree.name));
