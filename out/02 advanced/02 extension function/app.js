...
falseValue.ifFalse(() => GlobalFunctions_1.println("I am false"));
// Declare Boolean variable, initialize it with true and call extension function ifTrue
const trueValue = true;
trueValue.ifTrue(() => GlobalFunctions_1.println("I am true"));
...
text.ifNotEmpty(value => {
    ...
    GlobalFunctions_1.println(`Value is my text object and it is filled with ${value}`);
});
// Declare string variable, initialize it by setting space as text and call extension function ifNotEmpty
const emptyText = "";
text.ifNotEmpty((value) => {
    GlobalFunctions_1.println(`This code will never be executed as 'emptyText' is space.`);
});
