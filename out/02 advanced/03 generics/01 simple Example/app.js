...
/**
 * class that is responsible for containing a specific value. Next to the creation we can access that value.
...
// Thanks to generics we know 'value' is here a number so I can build a sum
